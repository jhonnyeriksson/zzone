...
# 3. ned-settings extreme-xos proxy
-----------------------------------
...
# 4. ned-settings extreme-xos connection
----------------------------------------
...
# 5. ned-settings extreme-xos console
-------------------------------------
...
## 5.1. ned-settings extreme-xos console extension warning
----------------------------------------------------------
...
## 5.2. ned-settings extreme-xos console extension command
----------------------------------------------------------
...
## 5.3. ned-settings extreme-xos console extension pattern
----------------------------------------------------------
...
## 5.4. ned-settings extreme-xos console extension action
---------------------------------------------------------
...
### 5.4.1. ned-settings extreme-xos console extension action state
------------------------------------------------------------------
...
# 6. ned-settings extreme-xos logger
------------------------------------
...
# 7. ned-settings extreme-xos write
-----------------------------------

  Settings used when writing to device.


## 7.1. ned-settings extreme-xos write inject-command
-----------------------------------------------------
